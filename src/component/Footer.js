        ...
        <footer className='footer py-20 bg-ftr_bg bg-no-repeat bg-center'>
            <div className='max-w-1400 mx-auto'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 py-10 lg:py-20 mx-0 lg:-mx-4 '>
                    <div className='footerWidget lg:text-left text-center px-4'>
                    ...
                    <p className="font-poppins text-16 font-light leading-24">Join our mailing list to get updates.We respect your privacy.</p>
                        <form className='relative mt-6'>
                            ...
                            <button type='submit' className='bgGradient h-60 w-60 rounded-full text-black inline-block text-20 flex justify-center items-center absolute top-10px right-10px'><FaRegPaperPlane /></button>
                        </form>
                    </div>
                </div>
